...
#define TLS_WRITE_OVERHEAD      ( SHA1_LEN + CIPH_BLOCK_SZ )
...
/* default processing app if none is provided */
extern RESULT http_process( BYTE**, SHORT, BYTE**, SHORT*, SHORT* );
